...
Dang it，George，你就是不放弃，是吧？

好吧，好吧。我们来走一遍。用户有一个问题。一个真正独特的问题，邮件列表档案、论坛中都找不到。互联网上唯一模糊提到这个问题的参考在一个 darknet 站点上，使用西伯利亚语。他们确实真诚地遇到了麻烦。

在任何人能帮助这个用户之前，他们需要有用地描述他们的问题。这意味着他们必须发送完整的问题描述。大多数撰写求助请求的人都不会费心提供 `uname -a` 的输出和 dmesg.boot 的副本。他们不会麻烦自己提供实际错误输出或 **/var/log/messages** 的内容。或者他们"有用"地剥离了他们认为不相关的内容，比如在他们的 Web 服务器日志中贯穿始终的 "PHP 正在转储核心" 消息。
