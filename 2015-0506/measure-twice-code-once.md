...
网络硬件早已突破 1 Gbps，10 Gbps 及更高速率连最小的公司也触手可及。虽然网络速度持续攀升，处理器速度却止步于约 3GHz，内存总线则更贴近处理器速度的增长。这些速度失配催生了这样的系统架构：试图把工作分摊到许多相似部件上来完成一项工作。多核、多内存总线、多网络队列都会在现代硬件上做基准测试时引入测量噪声。
