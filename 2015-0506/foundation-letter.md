...
在专栏与栏目方面，Steven Kreuzer 为《The Book of PF：OpenBSD 防火墙实战指南》撰写了书评。我们计划把书评作为期刊的固定栏目，让读者在两期之间也能读到些有趣的内容。如果你想写书评，或希望我们评论某本书，请通过 <editor@freebsdjournal.com> 告知我们。专栏部分还有 Frederic Culot 的最新 Ports 报告、Glen Barber（我们那位永远忙碌的发布工程师）的 SVN 更新，以及基金会执行董事 Deb Goodkin 撰写的 FreeBSD 基金会动态。Dru Lavigne 在“FreeBSD 本月动态”中带来了一篇与 Julio Merino 的精彩访谈。Julio 从一名参与开源的学生到入职 Google 的经历横跨多个 BSD 项目，颇为引人入胜。
