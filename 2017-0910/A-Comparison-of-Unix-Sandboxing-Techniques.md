...
![Figure 1：Generic Software Wrapper Toolkit 和 systrace 的系统调用封装器行为策略](../png/2017-0910/a-comparison-of-unix-sandboxing-techniques-01.png)
...
![Figure 2：进入 Linux 安全计算模式最初的“纯”版本](../png/2017-0910/a-comparison-of-unix-sandboxing-techniques-02.png)
...
![Figure 3：简单的 seccomp-bpf 过滤器示例](../png/2017-0910/a-comparison-of-unix-sandboxing-techniques-03.png)
...
自 2016 年 v5.9 发布以来，OpenBSD 引入了 pledge(2)，一种将进程置于“受限服务操作模式”的机制 5。pledge(2) 的手册页并未将其描述为安全机制 [Pled17]，但其开发者的其他交流中明确指出了安全意图 [deRa15]。pledge(2) 的核心是对 seccomp(2) 概念的一种更简单易用的实现。
...
![Figure 4：使用 pledge(2) 安装系统调用过滤策略](../png/2017-0910/a-comparison-of-unix-sandboxing-techniques-04.png)
...
![Figure 5：为 bhyve 虚拟机监控器添加 Capsicum 支持](../png/2017-0910/a-comparison-of-unix-sandboxing-techniques-05.png)
...
[AGW17] Anderson, J.; Godfrey, S.; Watson, R. N. M. “Toward Oblivious Sandboxing with Capsicum”，FreeBSD 期刊，2017 年 7/8 月，网址：[https://www.freebsdfoundation.org/past-issues/security](https://www.freebsdfoundation.org/past-issues/security)
