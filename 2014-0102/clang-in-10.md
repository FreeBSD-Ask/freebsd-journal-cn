...
这在 Ports 中造成一些问题，因为少数库不能用 clang 编译，因此不能用 libc++，而另一些需要 C++11，因此不能用我们的 base GCC 编译。使用 Ports 中的 GCC 也不能真正解决此问题，因为许多旧的 C++ 程序也不能用新 GCC 编译，而且新的 libstdc++ 与我们 base 系统中的也不二进制兼容。
