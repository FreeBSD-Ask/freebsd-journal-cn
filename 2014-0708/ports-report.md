...
过去两个月 Ports 树上的活动相当多！好消息也不少——新的提交者加入项目，还有令人兴奋的新工具来减轻我们在 ports 上的工作。

## 新的 Ports 提交者

我们当中一些提交者还记得收到提交权限（commit bit）的那一天是多么特别。我起初感到自己充满力量，因为可以登录到 FreeBSD 官方主机，但很快这种心情转为焦虑，因为常言道"权力越大，责任越大"！现在轮到两位新秀加入——Bartek Rutkowski 和 Stephen Hurd。希望他们能在 FreeBSD 上的工作和我一样乐在其中！
...
Ports 管理团队（portmgr）也发生了一些重大变化——有喜讯，也有不幸的坏消息。

- 先说喜讯：Steve Wills 被授予 portmgr 团队的正式成员资格。Steve 在 ports 上做了大量工作，尤其是在测试领域。Ports 管理员认为赋予 Steve 完整投票权是公正的回报，吸纳他加入团队也将有助于确保 ports 测试领域的未来改进。
...
过去两个月带来了一些令人兴奋的新工具，用于跟踪 Bug 和简化代码评审流程。关于 Bug 跟踪，关于脱离 GNATS 的必要性的讨论其实早在 10 年前就开始了！但切换最终才完成，我们现在依赖 Bugzilla（<https://bugs.freebsd.org/bugzilla/>）。这次过渡仍有少数边角情况需要打磨，但开发者们对切换到更现代的 Bug 跟踪器总体感到满意。对于尚未熟悉 FreeBSD 问题报告管理方式的读者，建议从 <http://www.freebsd.org/support/bugreports.html> 入手，该页面提供了有用的链接。
...
20 年后，这套宏集合似乎仍然相当好用。自始至今，已有超过 500 名提交者参与该项目，产生了超过 300,000 次提交，让近 25,000 个 ports 保持最新。衷心感谢所有奉献出空闲时间和精力促成这一切的人，我热切期待 20 年后我们将走向何方。与此同时，欲了解此纪念日的惊喜，请关注我们的博客（<http://blogs.freebsdish.org/portmgr/>）和社交网络页面：
