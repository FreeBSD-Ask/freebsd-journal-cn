...
QUIC 是一种新的基于 UDP 的传输协议，旨在替代 http/2。该协议最初由 Google 开发，后由 IETF 接手作为工作项。经过大量努力，工作组现已接近发布 QUICv1。QUICv1 设计了新的 HTTP 层 HTTP3，将用全面加密的协议替代 Web 中的 HTTP2。强加密与认证是 QUIC 的根基，以至于大多数协议头部对网络 obscured 不可见。
