...
此处介绍的支持基于基础工作，以模拟器为主要目标（ARM Foundation Model）。因此 ThunderX 的平台支持部分与 FreeBSD 基础系统的开发并行进行，偶尔相互交织。ThunderX 也是首个从 ARM 模拟器切换到真实硬件的平台。最终结果是功能完整的操作系统，支持以下关键芯片特性：
