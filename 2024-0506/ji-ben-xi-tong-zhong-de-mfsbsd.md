...
![mfsBSD 文章配图](https://freebsdfoundation.org/wp-content/uploads/2024/07/art1.png)
...
2023 年 5 月（即此篇文章写作的前一年），谷歌编程之夏（Google Summer of Code，GSoC）项目开始了将 mfsBSD 集成到基本系统的尝试。
