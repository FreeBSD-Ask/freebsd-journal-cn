...
![MS-DOS 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.36.01%CE%93CPM.png)

![MS-DOS 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.36.16%CE%93CPM.png)

虽然安装过程在文本模式下进行，但进度条和针对用户输入的高亮已经问世。

![MS-DOS 安装进度条界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.36.36%CE%93CPM.png)

![MS-DOS 安装进度条界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.37.00%CE%93CPM.png)

另一方面，Windows 安装程序（此处为 3.11 版）很快使用了自身的图形界面安装，如下所示。

![Windows 3.11 图形安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.37.15%CE%93CPM.png)

![Windows 3.11 图形安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.37.42%CE%93CPM.png)
...
![Windows 95 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.38.22%CE%93CPM.png)

![Windows 95 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.38.40%CE%93CPM.png)

![Windows 95 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.39.15%CE%93CPM.png)

![Windows 95 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.39.29%CE%93CPM.png)

将 Windows 98 纳入讨论值得一提，因为它带来了一些改进：安装步骤总览列表和剩余时间估算⁵。

![Windows 98 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.39.51%CE%93CPM.png)

![Windows 98 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.40.11%CE%93CPM.png)

我就不再展示其他版本的 Windows 安装过程了。只要加上 Windows 7，就能总结出以下有关安装程序可用性的模式⁶：

![Windows 7 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.40.25%CE%93CPM.png)

![Windows 7 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.40.38%CE%93CPM.png)
...
![FreeBSD 安装器界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.40.59%CE%93CPM.png)

![FreeBSD 安装器界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.41.13%CE%93CPM.png)
...
![Ubuntu Server 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.41.40%CE%93CPM.png)

![Ubuntu Server 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.41.53%CE%93CPM.png)
...
![Ubuntu Desktop 图形安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.42.11%CE%93CPM.png)

![Ubuntu Desktop 图形安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.42.24%CE%93CPM.png)
...
在可用性方面，这无疑是一个参考标准。至于 Microsoft Windows，这种表现可以说是商业支持下的解决方案应有的水平。但为了更公平地比较 FreeBSD，我们应将其与另一个社区项目对比。因此，在深入探讨 FreeBSD 自身的安装程序之前，不妨先看看 Ubuntu 的母项目、非商业发行版：Debian。

## Debian GNU/Linux

**译者注：Debian 亦有高级安装模式（Expert Mode），原作者测评的是普通安装模式。在高级安装模式下可对每个选项精确规划。**
...
![Debian 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.42.44%CE%93CPM.png)

![Debian 安装界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.42.56%CE%93CPM.png)
...
这一点令人印象深刻，堪比前文提到的商业解决方案；但同样，这样的比较对我们心爱的 FreeBSD 并不公平。不过，我仍想强调一点：系统中应当至少提供足够的基本工具，以便分析和修复；这在意外情况下可能就是救命稻草。
...
- `auto` 会依次执行以下操作：
  ...
  - **finalconfig**：一个“并不终结”的菜单，能在重启前做进一步更改。
...
它由一个基于 PXE 的设置组成，可针对传统的 PXE 环境和更现代的、基于 UEFI 的网络引导调整。我将此引导序列与一台 TFTP 服务器（由 `inetd` 管理）、DHCP 服务（使用 `isc-dhcp44-server` Port）以及只读的 NFS 挂载结合在一起。完整描述该设置超出了本文的范围，但归根结底，FreeBSD 安装器的可用性也取决于其开发环境的便利性。你可以根据自己的需求自由调整以下配置片段。
...
你可以将 **/jail/bsdinstall** 文件夹设置为一个典型的 Jail，并根据安装器的常规启动环境调整，或者也可以直接暴露 release 构建中的 `disc1` 目录。无论哪种方式，这种方法都能避免在开发 `bsdinstall` 时频繁地生成、传输或重启镜像文件。
...
2024 年初，FreeBSD 基金会委托我调研开源领域中图形化安装器的最新进展。其根本目标是为 FreeBSD 项目寻找一种可行方案来增加图形安装功能。Linux 上一个新的安装框架 Calamares¹² 是显而易见的候选者——前提是确认它可以用于 FreeBSD 作为目标系统。不幸的是，由于 Calamares 使用 GPL 许可证，与 FreeBSD 基本系统的目标用户群不兼容。
...
![gbsddialog 图形安装器界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.43.22%CE%93CPM.png)

![FreeBSD 图形 Live 系统替代界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/freebsd_graphical_live_replacement.png)

![gbsddialog 图形安装器界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.44.08%CE%93CPM.png)

![gbsddialog 图形安装器界面](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.44.23%CE%93CPM.png)
...
![DeforaOS 桌面环境与虚拟键盘](https://freebsdfoundation.org/wp-content/uploads/2025/07/Screenshot_2025-06-04_at_12.44.40%CE%93CPM.png)
