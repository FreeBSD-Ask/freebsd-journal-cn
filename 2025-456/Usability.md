...
![MS-DOS 安装界面](../png/2025-456/Usability-01.png)

![MS-DOS 安装界面](../png/2025-456/Usability-02.png)

虽然安装过程在文本模式下进行，但进度条和针对用户输入的高亮已经问世。

![MS-DOS 安装进度条界面](../png/2025-456/Usability-03.png)

![MS-DOS 安装进度条界面](../png/2025-456/Usability-04.png)

另一方面，Windows 安装程序（此处为 3.11 版）很快使用了自身的图形界面安装，如下所示。

![Windows 3.11 图形安装界面](../png/2025-456/Usability-05.png)

![Windows 3.11 图形安装界面](../png/2025-456/Usability-06.png)
...
![Windows 95 安装界面](../png/2025-456/Usability-07.png)

![Windows 95 安装界面](../png/2025-456/Usability-08.png)

![Windows 95 安装界面](../png/2025-456/Usability-09.png)

![Windows 95 安装界面](../png/2025-456/Usability-10.png)

将 Windows 98 纳入讨论值得一提，因为它带来了一些改进：安装步骤总览列表和剩余时间估算 ⁵。

![Windows 98 安装界面](../png/2025-456/Usability-11.png)

![Windows 98 安装界面](../png/2025-456/Usability-12.png)

我就不再展示其他版本的 Windows 安装过程了。只要加上 Windows 7，就能总结出以下有关安装程序可用性的模式 ⁶：

![Windows 7 安装界面](../png/2025-456/Usability-13.png)

![Windows 7 安装界面](../png/2025-456/Usability-14.png)
...
![FreeBSD 安装器界面](../png/2025-456/Usability-15.png)

![FreeBSD 安装器界面](../png/2025-456/Usability-16.png)
...
![Ubuntu Server 安装界面](../png/2025-456/Usability-17.png)

![Ubuntu Server 安装界面](../png/2025-456/Usability-18.png)
...
![Ubuntu Desktop 图形安装界面](../png/2025-456/Usability-19.png)

![Ubuntu Desktop 图形安装界面](../png/2025-456/Usability-20.png)
...
![Debian 安装界面](../png/2025-456/Usability-21.png)

![Debian 安装界面](../png/2025-456/Usability-22.png)
...
![gbsddialog 图形安装器界面](../png/2025-456/Usability-23.png)

![FreeBSD 图形 Live 系统替代界面](../png/2025-456/Usability-24.png)

![gbsddialog 图形安装器界面](../png/2025-456/Usability-25.png)

![gbsddialog 图形安装器界面](../png/2025-456/Usability-26.png)
...
![DeforaOS 桌面环境与虚拟键盘](../png/2025-456/Usability-27.png)
