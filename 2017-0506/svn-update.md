...
3BSD 许可的 ChaCha20 流密码实现，供即将到来的 `arc4random` 替代使用（https://svnweb.freebsd.org/changeset/base/316982）
...
请联系 Jim Maurer（jmaurer@freebsdjournal.com）提出你的文章创意。
