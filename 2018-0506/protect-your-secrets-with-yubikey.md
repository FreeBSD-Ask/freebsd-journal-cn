...
可以使用两步验证与 谷歌、Facebook、GitHub 和 Hotmail 等 Web 服务配合使用。这很有用，因为即使攻击者窃取了第一个认证因素（账户的用户名和密码），他们也无法登录。我们可以通过使用支持 U2F 的 YubiKey 设备来确保这一点。当然，我们必须在所选 Web 服务上启用两步验证。
