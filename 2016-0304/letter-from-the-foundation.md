...
DTrace 等高级追踪系统是 FreeBSD 的标准特性，它们的出现使得重新思考操作系统课程的教学方式成为可能。剑桥大学的 Robert Watson 两年来一直在使用追踪和 FreeBSD 教授研究生课程，我也在各种会议和工业场景中为从业者教授过类似版本。我们构建和开设这门课程的经验详见《用 FreeBSD 教学——通过追踪、分析与实验》一文，该课程还以宽松许可证在线发布。
