...
Vagrant 可以通过一个名为 vagrant-bhyve（<https://github.com/jesa7955/vagrant-bhyve>）的项目与 Bhyve 配合使用，该项目在 2016 年的 Google 编程之夏期间创建。要使用它，你可能还需要另一个项目——vagrant-mutate（<https://github.com/sciurus/vagrant-mutate>），帮助把 VM 转换为 vagrant-bhyve 能理解的格式。在 FreeBSD 上，两者都可通过运行以下命令安装：
