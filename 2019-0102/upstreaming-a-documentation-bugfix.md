...
由于 FreeBSD 本身并不维护 sudo 软件（除了一些本地补丁），正确的处理方式不是仅在我们自己的项目中本地修复，而是向上游报告问题。这样，sudo 项目不仅能知晓该问题，还能着手解决。问题被修复并发布更正版本后，其它所有项目（包括 FreeBSD）在安装较新版本时都会收到这些修复。其影响范围远超仅在本地修复问题。
