...
对软件开发者来说，最重要的问题是所选语言是否被 FreeBSD 支持。所有主流语言 FreeBSD 都支持，几乎没有任何限制。你想用 Node.js、PHP 或 Python 做新的 Web 项目？FreeBSD 全都支持。如果你更关注 Go 或 Rust 这类底层编程，FreeBSD 也有。想要更经典一些？在 Ports 中可以找到新版本的 clang 与 gcc。甚至可以通过 OpenJDK 使用 Java，或通过 Mono 使用 C#。
