...
至此你应该可以开始使用 FreeBSD 了。下一步建议选择并配置一个防火墙。FreeBSD Journal 2014 年 5/6 月号有一篇精彩文章《IPfw An Overview》，可指导你完成该过程。此外，读一读《BSD Hacks》这本书，可以让你更熟悉 `tcsh` shell，并掌握若干新技能。 •
