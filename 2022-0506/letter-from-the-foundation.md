...
最近，《Journal》的编辑委员会开会规划了未来一年的各期。我们进行了活跃、富有成效且范围广泛的讨论，涵盖 FreeBSD 世界的各种话题。从 2022 年 9/10 月刊开始，《Journal》将以安全、可观测性与度量、构建 FreeBSD Web 服务器、嵌入式、FreeBSD 三十周年、容器与云等主题推出专刊。我们还计划在 FreeBSD 14.0 发布时同步出版一期以 FreeBSD 14 为主题的期刊。
