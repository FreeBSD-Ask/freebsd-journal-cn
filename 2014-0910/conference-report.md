...
开发者峰会结束后，会议正式开始。首先要说的是，我特别喜欢所有主要 BSD 都参与了本次会议。会议的开场是主题演讲。FreeBSD Ports 集合的创建者 Jordan Hubbard 发表了一场关于 FreeBSD 未来 20 年的演讲，以及如何使其在市场上更具竞争力。
...
有趣的是，在会议最后一天，George Neville-Neil 和 Sean Bruno 成功在 Linilo（一种廉价的嵌入式 MIPS 系统）上启动了 FreeBSD。会议结束时，Atanas Chobanov 发表了关于匿名文档提交的演讲。随后，FreeBSD 基金会抽奖送出一本《The Design and Implementation of the FreeBSD Operating System》（第 2 版），谷歌则抽奖送出一台 Chromebook。
