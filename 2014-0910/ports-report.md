...
9 月 1 日，我们将告别旧的 `pkg_` 工具（详见 [http://blogs.freebsdish.org/portmgr/2014/02/03/time-to-bid-farewell-to-the-old-pkg_-tools/]）。经过多年服务，它们将被全新闪亮的 `pkg(8)` 取代。伴随这次切换，所有剩余的未暂存（unstaged）Port 将被移除，这将打开通往更佳的树内 QA 和许多激动人心之事的大门！准备好迎接伟大的新功能吧，比如以非 root 用户身份构建和打包、无需安装即可打包，以及创建子包的能力。Ports 树的未来一片光明！
...
如上一期专栏所宣布，Ports 树的 20 周年纪念于 8 月 21 日庆祝，并为此发布了一段视频 [http://youtu.be/LiFq5D-zmBs]。我们很高兴地看到，这段视频在两天内被约 2,000 人观看！

## Ports 树的值得关注的变更

尽管是暑假，仍有一些值得一提的变更。其中包括：季度分支 2014Q3 已分出，pkg 工具已更新到 1.3.7 版本，还进行了大量清理工作，主要与避免使用基本系统中的 texinfo 和 libreadline，以及处理未暂存 Port 有关。
