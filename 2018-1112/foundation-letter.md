...
欢迎来到 2018 年最后一期 FreeBSD Journal，以及 FreeBSD 12.0 的发布。但首先，我们有一个重大公告。从 2019 年 1 月/2 月期开始，FreeBSD Journal 将向所有人免费。

是的，免费。

你可能会问，为什么？FreeBSD 基金会使命的很大一部分是在全世界提升对 FreeBSD 的认知。我们知道 FreeBSD Journal 是让对 FreeBSD 感兴趣的人保持最新信息的最佳场所。我们的文章及时且信息丰富。因此，基金会决定，让所有人免费访问的益处将超过制作成本。但是，如果你想帮助支持 Journal，我们仍接受捐赠。

这还不是全部。我们还在推出增强版的浏览器版本，将为读者提供好得多的体验。

进入 2019 年，我想感谢 FreeBSD Journal 的作者、编辑和出版人员今年的所有辛勤工作。密切关注我们接近 2019 年 1 月/2 月期发布时的更多公告。有问题？请随时联系我们。
...
FreeBSD Journal（ISBN：978-0-615-88479-0）每年出版 6 期（1 月/2 月、3 月/4 月、5 月/6 月、7 月/8 月、9 月/10 月、11 月/12 月）。
