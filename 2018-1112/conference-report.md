...
Maya Rashish 的“Debugging Lessons Learned as a Newbie Fixing NetBSD”跟随一位新手的视角，了解为 NetBSD 贡献的过程，详细介绍了新加入项目的人应该注意的一些事情。Maya 的演讲结束后，我赶上了 Niclas Zeising 的“FreeBSD Graphics”结尾部分，我询问了编译 drm-stable-kmod 过程中的一个问题。Makefile 中有一个标志 `ignore`，如果想在 FreeBSD 11.2-RELEASE（我使用的版本）上编译 port，需要移除该标志。Niclas 说这肯定是疏忽，在 11.2 上应该能正常工作。我告诉他我从 Makefile 中移除了标志 `ignore`，并在我的 11.2-RELEASE 笔记本上编译了 drm-stable-kmod，它一直运行良好。
