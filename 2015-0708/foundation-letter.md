...
FreeBSD 项目的一些新人只通过代码库认识我们，但要支撑这个代码库，不仅需要工程工作，还需要许多其他方面。FreeBSD 基金会通过赞助会议、提供法律支持和商标保护，以及处理许多作为软件开发者我们视为理所当然的琐碎事务来支持项目。在我们"与 FreeBSD 项目互动"的连载栏目中，基金会执行董事 Deb Goodkin 带我们走进基金会，展示基金会今天所做的工作并描绘明天的计划。
