...
第一部分”Foundation Elements”（基础要素）处理系统管理的结构性问题：计算机、服务、客户交互等等。谈的是结构，不是细节。一台工作站？两台？还是几百台。它们带来的问题与一两台截然不同。如何保持更新？如何确保非技术背景的新员工能使用机器，而不用整天给你打电话？如何以最少的精力维持运行？如何确保服务器始终在线？这些都是我曾经抱怨过的问题，而本部分一一作了回应。有一章关于数据中心，包括物理布局和维护设备概览的实用建议。这大概是作者们最接近细节的地方。本部分还描述了灾难恢复（什么，没有灾难？当然有灾难）、安全策略，以及关于客户关系的两章，分别题为”Helpdesks”（帮助台）和”Customer Care”（客户关怀）。还有一章关于职业道德。
