...
第一次真正试用 FreeBSD，我记得清清楚楚。5.0 发布消息在 Slashdot 上线那晚我就看到了。又是同样的情况：我又弄到一台老硬件，这次是 DEC AlphaStation 250。Linux 在这台机器上不太好用，我看到 Alpha CPU 是受支持架构，于是试了 FreeBSD，没让我失望。首先系统比我之前试过的 Linux 发行版快得多；其次，多亏 Handbook，我无需预备知识就能在系统上做很多事情。这让我很有成就感，从此入坑。
