...
全球各地的 ham 现日常使用 WSJT、WSJTX 和其衍生项目 WSPR，以极低功率与世界各地通信，不仅通过月球，还通过传统的电离层短波通信。（参见 <http://physics.princeton.edu/pulsar/K1JT/>）
