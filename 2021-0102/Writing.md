...
学者喜欢文档上加文档（再加文档）。如果学者无法自行验证某些事情，我们不太可能相信它。文档不全的操作系统无法经受住学术界普遍存在的怀疑态度。组织性和文档性是密切相关的。一个操作系统，如果其开发者优先考虑一致性，通常对于那些花时间了解它如何工作的用户来说，是可以理解的。良好的 man 页面、清晰的手册和一个由热心用户群体积极维护的 wiki——这三者是学者操作系统必须具备的最基本的秩序。
